...
echo "$(tput setaf 1)Veuillez remplir les champs qui vous sont demandés$(tput sgr0)"
...
echo "$(tput setaf 1)Veillez installer ce fichier sur chaque ordinateur qui pilotera un Robair. Celui-ci y compris$(tput sgr0)"
echo "$(tput setaf 1)sudo cp $ROBAIR_HOME/ssl/rootCA.crt /usr/local/share/ca-certificates/$(tput sgr0)"
echo "$(tput setaf 1)sudo update-ca-certificates$(tput sgr0)"
